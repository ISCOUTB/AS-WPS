 ...
 * ==========================================================================
 */
package org.wpsim.viewerlens.data;
 ...
 * @author jairo
 */
public class ViewerLensMessage extends DataBESA {
     ...
     */
    public ViewerLensMessage(String peasantMessage, String level, String peasantAlias) {
        this.level = level;
