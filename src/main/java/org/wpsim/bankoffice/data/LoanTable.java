...
public class LoanTable implements Serializable {
    ...
    private BankOfficeMessageType loanType;
    
    public LoanTable(String peasantFamily, double loanGranted, Integer maxTerm, Integer paidTerm, BankOfficeMessageType loanType){
    ...
    public BankOfficeMessageType getLoanType() {
        return loanType;
    }

    public void setLoanType(BankOfficeMessageType loanType) {
        this.loanType = loanType;
    }
